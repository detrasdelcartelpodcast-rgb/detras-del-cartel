...
| `11-emblema-cobrizo-final-fondo-blanco-1024.png` | 1024×1024 | **Emblema elegido por Vic (versión final de Stitch)**: mismo diseño que el 10 pero con margen alrededor y el nombre completo. "EN VENTA" y "REAL ESTATE PODCAST" **se dejan como están (decisión de Vic, 20-09)**. | Fondo blanco (RGB, sin transparencia). |
| `12-emblema-cobrizo-final-TRANSPARENTE-764.png` | 764×764 | **El 11 con el fondo exterior transparente** (hecho por Claude con relleno desde los bordes; la cinta blanca de "DETRÁS DEL CARTEL" se conserva, verificado sobre fondo oscuro y claro). **Es el que va en la web.** | Recortado al contenido con margen parejo. Bordes suaves de 2 px: si se ve un halo claro sobre negro, avisar. 764 px alcanza para ~380 px en pantalla retina; para portadas de Spotify/Apple (1400+ px) pedir versión más grande. |
...
| `../banners/banner-youtube-2560x1440.png` | 2560×1440, 3 MB | **Banner de YouTube listo para subir**: adaptado de `screen 8.png` de Stitch (1376×768). Todo el contenido entra en la zona segura de 1546×423 (visible en celular, tablet, computadora y TV); el resto es fondo. Se hizo con `tools/componer-banner-youtube.py`. | Quedó "VICTOR" sin tilde (pedido de Vic). Las líneas chicas (íconos, @usuario y sitio web) no se leen en celular; YouTube muestra los enlaces por su cuenta. "Nuevos episodios todos los meses" es una promesa a sostener. El sitio detrasdelcartel.com hoy muestra la página estacionada de Hostinger. |
