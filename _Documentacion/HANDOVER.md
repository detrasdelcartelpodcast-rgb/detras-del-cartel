...
- **Barra flotante de dispositivos** (`src/dev/DevSimulator.jsx`, solo localhost): celular / tablet / PC + rotar, arrastrable, como la de la webpage. Sin librerías nuevas. Verificado que el build de producción NO la incluye. **🔴 CRITERIO DE TONO (Vic, 20-09): esta web es de un PODCAST que INFORMA, no de servicios.** Nada de "te acompaño", "te ayudo", "auditoría gratuita" ni ofertas: los servicios de Vic y Daniel viven en sus propias webs. Los textos hablan de lo que hacen EN EL PROGRAMA (explicar, analizar, traducir números), no de lo que hacen por el cliente. Revisar todo texto nuevo contra este criterio. Además, para el vocabulario de Vic evitar "tasar/tasación", "avisos", "gratis".
