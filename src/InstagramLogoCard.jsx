...
/**
 * Componente oficial de logotipo en formato 1:1 para Instagram
 * Totalmente responsive, nítido y en vector puro.
 */
export default function InstagramLogoCard({ className = "w-80 h-80" }) {
  return (
    <div className={`relative flex items-center justify-center select-none bg-white rounded-2xl overflow-hidden ${className}`}>
      <svg
      ...
      >
        <defs>
          <linearGradient id="reactMetalRing" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <radialGradient id="reactStudioWarmth" cx="65%" cy="45%" r="55%">
            <stop offset="0%" stopColor="#EAA676"/>
          ...
          <linearGradient id="reactNavyBg" x1="0%" y1="0%" x2="60%" y2="100%">
            <stop offset="0%" stopColor="#06101E"/>
            <stop offset="100%" stopColor="#0F243E"/>
          </linearGradient>

          <linearGradient id="reactWoodGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <linearGradient id="reactMicGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <clipPath id="reactEmblemCircleClip">
            <circle cx="512" cy="450" r="280"/>
          </clipPath>

          <filter id="reactSoftShadow" x="-10%" y="-10%" width="125%" height="125%">
            <feDropShadow dx="0" dy="10" stdDeviation="14" floodColor="#000000" floodOpacity="0.3"/>
          </filter>
        </defs>

        {/* Fondo blanco base 1024x1024 */}
        <rect width="1024" height="1024" fill="#FFFFFF"/>

        {/* Grupo escalado para Safe Zone de Instagram */}
        <g transform="translate(512, 512) scale(0.88) translate(-512, -500)" filter="url(#reactSoftShadow)">
          {/* Aro exterior */}
          <circle cx="512" cy="450" r="308" fill="#0B192C"/>
          <circle cx="512" cy="450" r="296" fill="none" stroke="url(#reactMetalRing)" strokeWidth="12"/>
          <circle cx="512" cy="450" r="284" fill="none" stroke="#0B192C" strokeWidth="4"/>

          {/* Gráfico central clip */}
          <g clipPath="url(#reactEmblemCircleClip)">
            <rect x="200" y="150" width="620" height="620" fill="url(#reactStudioWarmth)"/>
            ...
            <g stroke="url(#reactMetalRing)" strokeWidth="2.5" fill="none" opacity="0.75">
            ...
            <path d="M 512 170 C 532 280, 482 360, 422 450 C 372 520, 402 620, 472 730 L 200 730 L 200 170 Z" fill="url(#reactNavyBg)"/>
            <path d="M 512 170 C 532 280, 482 360, 422 450 C 372 520, 402 620, 472 730" fill="none" stroke="#FCE5D2" strokeWidth="3" opacity="0.6"/>

            <polygon points="287,210 327,210 327,630 287,630" fill="url(#reactWoodGrad)" stroke="#2B1408" strokeWidth="3"/>
            ...
            <polygon points="252,250 507,265 507,305 252,290" fill="url(#reactWoodGrad)" stroke="#2B1408" strokeWidth="3.5"/>
            ...
            <text x="397" y="395" fill="#FCE5D2" fontSize="32" fontWeight="900" fontFamily="'Impact', 'Arial Black', sans-serif" letterSpacing="2" textAnchor="middle">
              EN
            </text>
            <text x="397" y="448" fill="#FCE5D2" fontSize="34" fontWeight="900" fontFamily="'Impact', 'Arial Black', sans-serif" letterSpacing="2.5" textAnchor="middle">
              VENTA
            </text>

            <g transform="translate(650, 485)">
              <ellipse cx="0" cy="115" rx="45" ry="12" fill="#240D05" opacity="0.6"/>
              <path d="M -40 110 C -40 98, 40 98, 40 110 Z" fill="url(#reactMicGrad)" stroke="#3E1505" strokeWidth="3"/>
              <rect x="-8" y="70" width="16" height="35" rx="3" fill="url(#reactMicGrad)" stroke="#3E1505" strokeWidth="2"/>
              <rect x="-14" y="66" width="28" height="8" rx="2" fill="#FDE1CB" stroke="#3E1505" strokeWidth="2"/>

              <path d="M -42 -20 C -48 55, 48 55, 42 -20" fill="none" stroke="url(#reactMicGrad)" strokeWidth="8" strokeLinecap="round"/>
              ...
              <rect x="-27" y="-15" width="54" height="42" rx="4" fill="url(#reactMicGrad)" stroke="#2B0E03" strokeWidth="3"/>
              <rect x="-29" y="-2" width="58" height="6" fill="#FDE1CB" stroke="#2B0E03" strokeWidth="2"/>

              <path d="M -26 -15 C -26 -65, 26 -65, 26 -15 Z" fill="url(#reactMicGrad)" stroke="#2B0E03" strokeWidth="3"/>
          ...
          {/* Tipografía */}
          <g transform="translate(512, 715)" textAnchor="middle">
            <text y="0" fontFamily="'Impact', 'Arial Black', sans-serif" fontSize="58" letterSpacing="2.5" fontWeight="900">
              <tspan fill="#0B192C">DETRÁS DEL </tspan>
              <tspan fill="url(#reactMetalRing)" stroke="#0B192C" strokeWidth="2">CARTEL</tspan>
            </text>

            <g transform="translate(0, 32)">
              <polygon points="0,-4 5,0 0,4 -5,0" fill="#C26A3B"/>
              <line x1="-220" y1="0" x2="-15" y2="0" stroke="url(#reactMetalRing)" strokeWidth="1.8" opacity="0.85"/>
              <line x1="15" y1="0" x2="220" y2="0" stroke="url(#reactMetalRing)" strokeWidth="1.8" opacity="0.85"/>
            </g>

            <text y="54" fill="#C26A3B" fontFamily="'Plus Jakarta Sans', system-ui, sans-serif" fontSize="18" fontWeight="900" letterSpacing="5">
              REAL ESTATE PODCAST
            </text>

            <path d="M -180 72 C -90 108, 90 108, 180 72" fill="none" stroke="url(#reactMetalRing)" strokeWidth="7" strokeLinecap="round"/>
            <path d="M -160 84 C -80 118, 80 118, 160 84" fill="none" stroke="#0B192C" strokeWidth="2.5"/>
          </g>
        </g>
      </svg>
    </div>
